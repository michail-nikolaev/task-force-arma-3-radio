...
_v0.9.4 (10-16-2014)_

#####Compatible with 0.9.3, not compatible with 0.9.2

###Installation

* Download and unzip [0.9.3 radio archive](https://github.com/michail-nikolaev/task-force-arma-3-radio/raw/master/releases/0.9.4.zip).
