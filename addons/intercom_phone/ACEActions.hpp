    ...
    class ACE_Actions { \
        class ACE_MainActions { \
            class TFAR_Intercom_Phone_Activate { \
                ...
                distance = 4; \
                condition = "isNil {_player getVariable ""TFAR_vehicleIDOverride""} && ([(typeOf _target), ""TFAR_hasIntercom"", 0] call TFAR_fnc_getVehicleConfigProperty) > 0 && isNil {_target getVariable [""TFAR_IntercomPhoneSpeaker"", nil]}"; \
                exceptions[] = {}; \
