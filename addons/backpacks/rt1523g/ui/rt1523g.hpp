...
class clear: HiddenButton
{
    ...
    action = QUOTE(ctrlSetText [ARR_2(IDC_RT1523G_EDIT, '')];ctrlSetFocus ((findDisplay IDD_RT1523G_RADIO_DIALOG) displayCtrl IDC_RT1523G_EDIT););
};
class enter: HiddenButton
{
    ...
    onButtonClick = QUOTE([((ctrlParent (_this select 0))) displayCtrl IDC_RT1523G_EDIT] call TFAR_handhelds_fnc_onButtonClick_Enter;);
    action = "";
};
