...
////////////////////////////////////////////////////////
// GUI EDITOR OUTPUT START (by [TF]Nkey, v1.063, #Zozaci)
////////////////////////////////////////////////////////
...
class clear: HiddenButton
{
    ...
    action = QUOTE(ctrlSetText [ARR_2(IDC_MR3000_EDIT, '')];ctrlSetFocus ((findDisplay IDD_MR3000_RADIO_DIALOG) displayCtrl IDC_MR3000_EDIT););
};
...
class additional: HiddenRotator
{
    ...
    action = QUOTE(playSound 'TFAR_rotatorPush';[ARR_2(TF_lr_dialog_radio,TF_lr_dialog_radio call TFAR_fnc_getLrChannel)] call TFAR_fnc_setAdditionalLrChannel;call TFAR_fnc_updateLRDialogToChannel;[ARR_2(TF_lr_dialog_radio, true)] call TFAR_fnc_showRadioInfo;);
};
