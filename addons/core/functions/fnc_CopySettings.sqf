...
if (_isSLR) then {
    ...
    if (_isDLR) then {
        ...
        diag_log "$STR_TFAR_copySetting_LR_SW_Warning";
        hint "$STR_TFAR_copySetting_LR_SW_Warning";
    };
} else {
    ...
    if (!_isDLR) then {
        ...
        diag_log "$STR_TFAR_copySetting_SW_LR_Warning";
        hint "$STR_TFAR_copySetting_SW_LR_Warning";
    };
};
