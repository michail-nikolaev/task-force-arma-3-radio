...
/*
    Name: TFAR_fnc_instanciateRadio

    Author(s):
        gandjustas

    Description:
        Takes Radio classname and returns instanciated classname (With _ID appended)
        Internal use only!

    Parameters:
        0: STRING - classname of prototype Radio

    Returns:
        STRING - classname of instanciated Radio

    Example:
        ["TFAR_anprc_152"] call TFAR_fnc_instanciateRadio;
*/

params [ "_radioBaseClass"];
...
format["%1_%2", _radioBaseClass, _nextRadioIndex];//form new classname of baseclass_ID
