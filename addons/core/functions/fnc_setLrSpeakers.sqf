...
["OnLRspeakersSet", TFAR_currentUnit, [TFAR_currentUnit, _radio_object, _radio_qualifier, _settings select TFAR_LR_SPEAKER_OFFSET]] call TFAR_fnc_fireEventHandlers;
