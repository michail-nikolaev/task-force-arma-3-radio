...
["TFAR", "CycleSWRadiosRight", [localize LSTRING(key_CycleRightSWRadios), localize LSTRING(key_CycleRightSWRadios)], {true}, {["next"] call TFAR_fnc_processSWCycleKeys}, [TF_sw_cycle_next_scancode, TF_sw_cycle_next_modifiers], false] call cba_fnc_addKeybind;
["TFAR", "CycleSWRadiosLeft", [localize LSTRING(key_CycleLeftSWRadios), localize LSTRING(key_CycleLeftSWRadios)], {true}, {["prev"] call TFAR_fnc_processSWCycleKeys}, [TF_sw_cycle_prev_scancode, TF_sw_cycle_prev_modifiers], false] call cba_fnc_addKeybind;
["TFAR", "CycleLRRadiosRight", [localize LSTRING(key_CycleRightLRRadios), localize LSTRING(key_CycleRightLRRadios)], {true}, {["next"] call TFAR_fnc_processLRCycleKeys}, [TF_lr_cycle_next_scancode, TF_lr_cycle_next_modifiers], false] call cba_fnc_addKeybind;
["TFAR", "CycleLRRadiosLeft", [localize LSTRING(key_CycleLeftLRRadios), localize LSTRING(key_CycleLeftLRRadios)], {true}, {["prev"] call TFAR_fnc_processLRCycleKeys}, [TF_lr_cycle_prev_scancode, TF_lr_cycle_prev_modifiers], false] call cba_fnc_addKeybind;
