...
["TF_full_duplex", "CHECKBOX", [localize "STR_TFAR_Mod_FullDuplex",localize "STR_TFAR_Mod_FullDuplexDescription"], "Task Force Arrowhead Radio", true, true] call CBA_Settings_fnc_init;
// client
