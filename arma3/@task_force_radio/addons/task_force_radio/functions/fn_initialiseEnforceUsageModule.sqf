...
if (_activated) then {
	...
	TF_give_microdagr_to_soldier = !(_logic getVariable "give_microdagr_to_soldier");
	...
	if (isServer) then {
        tf_same_dd_frequencies_for_side = (_logic getVariable "same_dd_frequencies_for_side");
