...
_v0.8.3 от 13.03.2014_

**<font color="green">TeamSpeak 3.0.14 поддерживается</font>**

###Установка

* Скачайте [архив с рацией 0.8.3](https://github.com/michail-nikolaev/task-force-arma-3-radio/raw/master/releases/0.8.3.zip) и распакуйте его.
...
* По умолчания все игроки в одной группе имееют одинаковые настройки персональных раций. Чтобы установить иденичные настройки для игроков всей стороны: `tf_same_sw_frequencies_for_side = true;`
