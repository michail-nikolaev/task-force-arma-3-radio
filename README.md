...
* Используйте `CTRL` + `P`, чтобы открыть интерфейс рации (у вас в инвентаре должна быть рация в слоте). Для того, чтобы ввести частоту нажмите `CLR`, введите значение и нажмите `ENT`
