...
> [TFAR](http://radio.task-force.ru/) использует последнюю версию [СBA](http://www.armaholic.com/page.php?id=18767) (Community Base Addons). Поэтому, если этот мод у вас уже установлен, Windows предложит заменить папку.
...
| `SHIFT` + `P` | Открыть интерфейс переговорного устройства для водолазов (на вас должен быть надет ребризер).| 
| `CTRL` + `~` | Разговор по переговорному устройству для водолазов. |
...
| `T` | Передача на дополнительном канале рации командира. |
...
| :--- | :--- | :--- |
| :radio: [AN/PRC-152](http://ru.wikipedia.org/wiki/AN/PRC-152) (рация командира) | <span style="color:blue">Синие</span> | 30-512Mhz / 5 км |
| :radio: [RF-7800S-TR](http://rf.harris.com/capabilities/tactical-radios-networking/rf-7800s-tr.asp) (рация бойца) | <span style="color:blue">Синие</span> | 30-512Mhz / 2 км |
...
| :radio: [AN/PRC148-JEM](https://www.thalescomminc.com/ground/anprc148-jem.asp) (рация командира) | <span style="color:green">Независимые</span> | 30-512Mhz / 5 км | 
| :radio: [AN/PRC-154](http://www.gdc4s.com/anprc-154a-rifleman-radio.html) (рация бойца) | <span style="color:green">Независимые</span> | 30-512Mhz / 2 км | 
...
| :radio: [FADAK](http://www.iran.ru/news/politics/87228/Iran_prodemonstriroval_tri_novyh_obrazca_voennogo_naznacheniya) (рация командира) | <span style="color:red">Красные</span> | 30-512Mhz / 5 км | 
| :radio: [PNR-1000A](http://elbitsystems.com/Elbitmain/files/Tadiran%2520PNR1000A_2012.pdf) (рация бойца) | <span style="color:red">Красные</span> | 30-512Mhz / 2 км | 
...
| :radio: Подводный приемопередатчик | Все | 32-41kHz / 70-300 м<br />(в&nbsp;зависимости&nbsp;от&nbsp;уровня&nbsp;волн) |

> Ручная и дальняя рации одной фракции поддерживают единый протокол, поэтому могут связываться друг с другом. В случае если передача осуществляется с ручной -  звук будет высокочастотным. В случае передачи с дальней - низкочастотным. 
...
> Рация командира и рация дальней связи позволяют одновременно принимать и передавать два канала. Нажатие на рации «Настроить дополнительный канал» сделает текущий канал дополнительным. Переключившись на другой канал вы будет слышать два канала - активный и дополнительный.
...
####В технике
* Рация дальней связи доступна в технике водителю, командиру, стрелку и помощнику пилота. Не вся техника имеет встроенные рации.
...
* По умолчанию рации каждой фракции используют свои коды шифрования, поэтому вы не будете слышать вражеские переговоры, даже введя используемую врагами частоту. Чтобы прослушивать (и говорить в эфир) противника - необходимо каким-либо образом захватить вражескую радиостанцию.
...
* Вы не можете пользоваться радио связью под водой (ни говорить, ни слышать). Если нужно что-то передать на сушу - всплывайте. Исключение - подводный аппарат на перископной глубине (в нем водолазам можно использовать рацию дальней связи).
